...
module Minitest::Dry::Monads::Assertions::Maybe
  # Maybe
  ...
  def assert_some(obj, msg = nil)
    assert_instance_of(Dry::Monads::Some, obj, msg)
  end

  def assert_some_(obj, value, msg = nil)
    assert_equal(obj, M.Some(value), msg)
  end

  def assert_none(obj, msg = nil)
    assert_instance_of(Dry::Monads::None, obj, msg)
  end
  ...
  def refute_none(obj, msg = nil)
    refute_instance_of(Dry::Monads::None, obj, msg)
  end
end
